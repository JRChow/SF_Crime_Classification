...
seasons_table <- table(seasons$Season)
seasons_std <- data.frame(Spring=table(seasons$Category, seasons$Season)[,"Spring"]/seasons_table["Spring"], 
                          Summer=table(seasons$Category, seasons$Season)[,"Summer"]/seasons_table["Summer"],
                          Fall=table(seasons$Category, seasons$Season)[,"Fall"]/seasons_table["Fall"],
                          Winter=table(seasons$Category, seasons$Season)[,"Winter"]/seasons_table["Winter"])
seasons_std 
g + theme(legend.position="right")
par(xpd=TRUE)
...
```{r}
library("wordnet")
synonyms(train$Category[1], "NOUN")
```
